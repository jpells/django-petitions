...
urlpatterns += patterns('sorted_paginated_authored_archived_list_view.views',
    ...
    (r'^$', 'sorted_paginated_authored_archived_list', petition_dict, "petitions_main"),
...
urlpatterns += patterns('django.views.generic.create_update',
    (r'^create/$', 'create_object', dict(model=Petition, login_required=True, extra_context={'STATE_DEFAULT': settings.STATE_DEFAULT}), "petitions_create"),
)
